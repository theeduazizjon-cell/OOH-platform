...
changed in 2025 and a replacement must be chosen; the web skeleton moves to Step 2 together with login.

**Goal:** a running, tested skeleton where tenant isolation is _proven by tests_ before any business table exists.
