...
- **Means:** one task engine with categories and related objects; an _operational_ calendar computed from real deadlines; event-driven, actionable notifications (in-app + email in MVP).
